...
Wenn Sie in einen öffentlichen Raum eingeladen werden, z.B. von einem Dozenten oder einer Dozentin für einen bevorstehenden Kurs, können Sie den Raum unter **[/explore](https://medienhaus.udk-berlin.de/explore)** finden. Einladungen zu privaten Räumen finden Sie am linken Bildschirmrand im **[/classroom](https://medienhaus.udk-berlin.de/classroom)** in der Navigationsspalte. 
...
Wenn Sie die Einladung nicht sehen, stellen Sie bitte sicher, dass Sie die Seite neu laden, indem Sie auf das Symbol 🔄 in Ihrem Browser klicken oder `cmd` + `r` verwenden. Öffentliche Räume finden Sie unter **[/explore](https://medienhaus.udk-berlin.de/explore)**.
