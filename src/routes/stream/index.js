...
const Stream = () => {
  ...
  return (
    <section className="stream copy">
      ...
      <p>{t('stream:p1')}</p>
      <p>{t('stream:p2')}</p>
      <p><del><Trans i18nKey="stream:p3"><strong>/stream</strong> can be accessed via: <a href="https://stream.medienhaus.udk-berlin.de" rel="external nofollow noopener noreferrer" target="_blank">stream.medienhaus.udk-berlin.de</a></Trans></del></p>
